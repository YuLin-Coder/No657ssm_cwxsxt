			...
			<div class="container">
				<div class="mws-panel grid_8">
					<div class="mws-panel-header">
						<span class="mws-i-24 i-pencil">编辑商品信息</span>
					</div>
					<div class="mws-panel-body">
						<form class="mws-form" name="myform" action="goods/updateGoods.action" method="post" onsubmit="return check();">
							<div class="mws-form-inline">

								<div class="mws-form-row">
									<label>商品名称</label>
									<div class="mws-form-item large">
										<input type="text" name="goodsname" class="mws-textinput" id="goodsname" value="${goods.goodsname}" />
									</div>
								</div>
								<div class="mws-form-row">
									<label>图片</label>
									<div class="mws-form-item large">
										...
										<input class="mws-textinput" type="text" name="goods.image" value="${goods.image}" id="image"
								...
								<div class="mws-form-row">
									<label>价格</label>
									<div class="mws-form-item large">
										<input type="text" name="price" class="mws-textinput" id="price" value="${goods.price}" />
									</div>
								</div>
								<div class="mws-form-row">
									<label>是否特价</label>
								...
								<div class="mws-form-row">
									<label>库存数</label>
									<div class="mws-form-item large">
										<input type="text" name="storage" class="mws-textinput" id="storage" value="${goods.storage}" />
									</div>
								</div>
								<div class="mws-form-row">
									<label>商品介绍</label>
							...
							<div class="mws-button-row">
								<input type="hidden" name="goodsid" id="goodsid" value="${goods.goodsid}" /><input type="hidden" name="addtime"
									...
									value="${goods.sellnum}" /> <input type="hidden" name="hits" id="hits" value="${goods.hits}" /> <input
