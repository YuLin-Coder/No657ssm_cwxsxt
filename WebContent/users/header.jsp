...
<div class="ng-header">
    ...
    letter-spacing: 3px;
    line-height: 50px;
    padding-left: 40px;"> 宠物销售网站
			</a>
			<div class="ng-search" style="margin-top: 10px;">
				<div class="g-search">
	...
	<div class="block">
		<div class="ng-nav-index">
			<ul class="ng-nav">
				...
				<li><a href="index/special.action" class="cur">特价商品</a></li>
				<li><a href="index/recommend.action" class="cur">推荐商品</a></li>
				<li><a href="index/all.action" class="cur">全部商品</a></li>
			</ul>
		</div>
	</div>
</div>
